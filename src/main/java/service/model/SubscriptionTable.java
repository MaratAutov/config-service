...
public class SubscriptionTable extends CustomTable<SubscriptionRecord> {
    public static final SubscriptionTable SUBSCRIPTIONS = new SubscriptionTable();
    ...
    public final TableField<SubscriptionRecord, String> VALUE = createField(name("VALUE"),
            SQLDataType.VARCHAR(1024));
